    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[400px] p-0 gap-0 bg-white dark:bg-menu-bg border border-gray-200 dark:border-gray-800 shadow-xl">
        ...
        <div className="p-8 pt-4 flex flex-col items-center bg-white dark:bg-menu-bg rounded-lg">
          <h2 className="text-xl font-semibold mb-1 text-gray-900 dark:text-grey-900">Please sign in to continue</h2>
            ...
            {loading ? (
              <>
                <span className="absolute inset-0 flex items-center justify-center">
                  <svg className="animate-spin h-5 w-5 text-grey-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
