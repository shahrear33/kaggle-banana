...
export default function ImageTransform({ onGenerated }) {
  ...
  return (
    <div>
      ...
      <Button onClick={handleGenerate} disabled={loading} className="w-full bg-black hover:bg-gray-800 text-grey-900 py-6 rounded-md flex items-center justify-center">
        {loading ? (
          <>
            <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-grey-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
