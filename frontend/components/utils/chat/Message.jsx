  ...
  return (
    <div className={`flex space-x-4 items-start p-4 ${isOwner ? 'flex-row-reverse space-x-reverse' : ''}`}>
      <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 
        ...
        {isOwner ? (
          <svg className="w-4 h-4 text-grey-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className={`max-w-[70%] ${isOwner ? 'bg-purple-600 text-grey-900' : 'bg-white dark:text-[#000]'} 
