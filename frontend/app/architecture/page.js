...
export default function FloorPlan3DWithCost() {
  ...
  const [showInputForm, setShowInputForm] = useState(true); // Control input form visibility
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (response.ok && data.image_url) {
        ...
        setShowInputForm(false); // Hide input form after successful generation
  ...
  const handleImageUpload = (event) => {
    ...
    if (file) {
      ...
      setShowInputForm(true); // Show input form when new image is uploaded
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-rose-100 font-sans">
      ...
      <main className="max-w-6xl mx-auto px-4 py-16">
        ...
        {showRoomSelection && rooms.length > 0 && generatedImage && generatedImage !== "" && (
              ...
              <div className="relative mb-8">
                ...
                {useSimpleViewer ? (
                  <div className="space-y-6">
                    {/* Generated 3D Image with Room Detection */}
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                      <div className="p-4 bg-gray-50 border-b flex items-center justify-between">
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900">Generated 3D Interior</h3>
                          <p className="text-sm text-gray-600">Hover over rooms, click to generate interiors</p>
                        </div>
                        {uploadedImageUrl && (
                          <Button
                            onClick={() => openModal(uploadedImageUrl, "Original Floor Plan - Click to close")}
                            variant="outline"
                            className="border-indigo-300 text-indigo-600 hover:bg-indigo-50 hover:border-indigo-400 font-medium shadow-sm hover:shadow-md transition-all duration-200"
                          >
                      ...
                      <div className="relative p-8">
                        <SimpleImageViewer
                          ...
                          showFullImage={true}
                          onImageClick={() => openModal(generatedImage, "Generated 3D Interior")}
                        />
                      </div>
                    </div>
                  </div>
        ...
        {roomInteriorImage && roomInteriorImage !== "" && selectedRoom && (
          <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 mb-16">
        ...
        {/* Generation Interface - Moved to bottom after images are generated */}
        {showInputForm && (
          <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 mb-16">
                  ...
                  {!uploadedImageUrl ? (
                    ...
                    <div className="border-2 border-dashed border-indigo-300 rounded-xl p-8 text-center hover:border-indigo-400 hover:bg-indigo-50/50 transition-all duration-300">
                      <div className="flex flex-col items-center space-y-3">
                        ...
                        <div>
                          <p className="text-base font-medium text-gray-700">Upload your file</p>
                    ...
                    <div className="relative group">
                      ...
                      <div className="mt-3 flex items-center justify-between bg-emerald-50 border border-emerald-200 rounded-lg p-3">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm font-medium text-emerald-700">Floor plan uploaded</span>
                        </div>
        ...
        {!showInputForm && (
          <div className="text-center my-8">
            <Button
              ...
              className="bg-gradient-to-r from-indigo-600 to-fuchsia-600 hover:from-indigo-700 hover:to-fuchsia-700 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
            >
              <MdOutlineDesignServices className="mr-2" />
              Generate New 3D Interior
            </Button>
          </div>
        )}
      </main>
            ...
            <div className="relative bg-white rounded-lg shadow-2xl overflow-hidden">
              ...
              <div className="p-4 bg-gray-50 border-t">
                <div className="flex justify-between items-center">
                  <p className="text-sm text-gray-600">Click outside to close or press ESC</p>
                  <button
                    onClick={closeModal}
