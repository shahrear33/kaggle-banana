...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 font-sans">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-slate-900 via-gray-900 to-black text-gray-900 py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-5xl md:text-6xl font-extralight tracking-tight leading-tight text-gray-900">
                Transform Your <span className="font-bold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">Space</span> into Reality
              </h2>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                className="bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-blue-800 text-grey-900 px-8 py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
              >
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-grey-900 px-8 py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
              >
      ...
      <main className="max-w-7xl mx-auto p-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-extralight text-gray-900 mb-4">
            Choose Your <span className="font-bold bg-gradient-to-r from-sky-600 to-purple-600 bg-clip-text text-transparent">Creative Path</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="group bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl hover:border-blue-200 transition-all duration-300 transform hover:-translate-y-2 cursor-pointer" onClick={handleArchitectureChoice}>
            <div className="flex items-center mb-8">
              <div className="p-4 bg-gradient-to-br from-indigo-100 to-cyan-100 rounded-2xl mr-6 group-hover:from-indigo-200 group-hover:to-cyan-200 transition-colors duration-300">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-cyan-50 rounded-xl p-6 mb-6">
            ...
            <Button className="w-full bg-gradient-to-r from-indigo-600 to-cyan-600 hover:from-indigo-700 hover:to-cyan-700 text-gray-900 py-3 rounded-xl font-semibold transition-all duration-300">
          ...
          <div className="group bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl hover:border-purple-200 transition-all duration-300 transform hover:-translate-y-2 cursor-pointer" onClick={handleInteriorChoice}>
            ...
            <Button className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-grey-900 py-3 rounded-xl font-semibold transition-all duration-300">
        ...
        <div className="mt-24">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extralight text-gray-900 mb-4">
              Why Choose <span className="font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">3D Vision AI</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group bg-white p-8 rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl hover:border-blue-200 transition-all duration-300 transform hover:-translate-y-2">
              <div className="p-4 bg-gradient-to-br from-indigo-100 to-cyan-100 inline-block rounded-2xl mb-6 group-hover:from-indigo-200 group-hover:to-cyan-200 transition-colors duration-300">
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl hover:border-green-200 transition-all duration-300 transform hover:-translate-y-2">
              <div className="p-4 bg-gradient-to-br from-emerald-100 to-emerald-100 inline-block rounded-2xl mb-6 group-hover:from-emerald-200 group-hover:to-emerald-200 transition-colors duration-300">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-br from-indigo-50 via-fuchsia-50 to-rose-100 text-gray-900 py-16 mt-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <MdOutlineArchitecture className="text-2xl text-indigo-600" />
                <h3 className="text-xl font-light text-gray-900">3D VISION <span className="font-bold">AI</span></h3>
              </div>
              <p className="text-gray-700 text-sm leading-relaxed">Revolutionizing architectural visualization and interior design with cutting-edge AI technology.</p>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-gray-900">Services</h4>
              <ul className="space-y-3 text-gray-700">
                <li><Link href="/architecture" className="hover:text-indigo-600 transition-colors">3D Architecture</Link></li>
                <li><Link href="/interior" className="hover:text-indigo-600 transition-colors">Interior Design</Link></li>
                <li><Link href="#" className="hover:text-indigo-600 transition-colors">Space Planning</Link></li>
                <li><Link href="#" className="hover:text-indigo-600 transition-colors">Visualization</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-300 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-700 text-sm">&copy; {new Date().getFullYear()} 3D Vision AI. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="#" className="text-gray-700 hover:text-indigo-600 transition-colors">Twitter</Link>
              <Link href="#" className="text-gray-700 hover:text-indigo-600 transition-colors">LinkedIn</Link>
              <Link href="#" className="text-gray-700 hover:text-indigo-600 transition-colors">Instagram</Link>
            </div>
          </div>
        </div>
      </footer>
